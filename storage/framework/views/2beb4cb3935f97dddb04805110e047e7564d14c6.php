<?php $__env->startSection('Container'); ?>
    ...
    <div class="vh-container vh-margin-bottom" style="margin-top:10px;">
        <div class="vh-row-padding">
            <!-- Image -->
            <div class="vh-col l6 m6 vh-center vh-hide-small"><img style="width: 750px; height: 500px;" class="vh-image" src="<?php echo e(asset('City10.png')); ?>"></div>
            <!-- Phần nhập thông tin -->
            <div class="vh-col l6 m6">
                <!-- Tab 1 -->
                <form action="<?php echo e(url('register')); ?>" method="post" onsubmit="return onclick_TestReg();">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\landmark98\resources\views/Auth/register.blade.php ENDPATH**/ ?>