...
<head>
    ...
    <title>Advertiser LandMark 98</title>
    ...
    <link rel="stylesheet" href="{{asset('css/landmark.css')}}">
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('advertise')}}"><img src="{{asset('images/LogoAdvertiser.png')}}" alt="Logo"></a>
            ...
            <div id="main-menu" class="main-menu ">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{url('login')}}"> <i class="menu-icon fa fa-home"></i>Trang chủ</a>
                    </li>
